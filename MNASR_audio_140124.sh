...
cd /tmp
set -e
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/MNASR_audio_140124.tar.gz"
wait
tar -xzf MNASR_audio_140124.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/MNASR_audio_140124.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
