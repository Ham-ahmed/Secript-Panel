...
cd /tmp
set -e
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/New_panel-ajpanel_v3.0-v4.0_HA.tar.gz"
wait
tar -xzf New_panel-ajpanel_v3.0-v4.0_HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/New_panel-ajpanel_v3.0-v4.0_HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
