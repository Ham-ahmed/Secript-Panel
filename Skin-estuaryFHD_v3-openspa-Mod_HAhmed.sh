...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/estuaryFHD_v3-openspa_Mod-HA.tar.gz"
wait
tar -xzf estuaryFHD_v3-openspa_Mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/estuaryFHD_v3-openspa_Mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
