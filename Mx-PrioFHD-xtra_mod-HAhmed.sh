...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/Mx-PrioFHD-xtra_mod-HAhmed.tar.gz"
wait
tar -xzf Mx-PrioFHD-xtra_mod-HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/Mx-PrioFHD-xtra_mod-HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
