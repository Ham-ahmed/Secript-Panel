...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/YouViX-4x1_posterX-Mod-HA.tar.gz"
wait
tar -xzf YouViX-4x1_posterX-Mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/YouViX-4x1_posterX-Mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
