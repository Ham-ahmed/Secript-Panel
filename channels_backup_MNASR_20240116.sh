#!/bin/sh
##
channel=Mohammed-Nasr
version=motor

echo "> Downloading "$channel" "$version" Channels List  Please Wait ......"
sleep 3s

wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/channels_backup_MNASR_20240116.tar.gz"
