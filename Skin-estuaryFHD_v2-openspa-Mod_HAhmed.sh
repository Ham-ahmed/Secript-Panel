...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skin2/main/estuaryFHD_openspa_Mod-HA.tar.gz"
wait
tar -xzf estuaryFHD_openspa_Mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/estuaryFHD_openspa_Mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
