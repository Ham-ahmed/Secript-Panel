...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/MX_GrayDots_vip-xtra_mod-HA.tar.gz"
wait
tar -xzf MX_GrayDots_vip-xtra_mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/MX_GrayDots_vip-xtra_mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
