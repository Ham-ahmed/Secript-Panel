...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/openplusFHD_posterX-Mod-HA.tar.gz"
wait
tar -xzf openplusFHD_posterX-Mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/openplusFHD_posterX-Mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
