...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/BlackSPAFHD_posterX-Mod-HA.tar.gz"
wait
tar -xzf BlackSPAFHD_posterX-Mod-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/BlackSPAFHD_posterX-Mod-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
