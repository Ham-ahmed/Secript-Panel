...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/panel-ajpanel_v2-HA.tar.gz"
wait
tar -xzf panel-ajpanel_v2-HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/panel-ajpanel_v2-HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
