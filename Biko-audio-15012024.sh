...
cd /tmp
set -e
 wget "https://raw.githubusercontent.com/Ham-ahmed/Secript-Panel/main/Biko_audio_150124.tar.gz"
wait
tar -xzf main/Biko_audio_150124.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/main/Biko_audio_150124.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
